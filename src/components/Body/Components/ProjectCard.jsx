...
export default function ProjectCard({ title, smdesc, link, techs, isLoaded }) {
  ...
  return (
    <li
      ...
      } md:max-w-1/2 lg:max-w-1/4 m-2 p-3 border-2 lg:border-0 relative origin-top rounded-lg ${
        ...
        <div className="flex flex-col">
          <div id="title" className="py-3 flex gap-3">
            ...
            <div className="w-[40px] h-[40px] flex">
              <p
                className={`text-white text-2xl origin-top ${
                  Hovered ? "scale-y-100 opacity-100" : "scale-y-0 opacity-0"
